    ...
    <li class="" >
       <div id="memorandum">
        <!-- <h4 style="margin: -5px 0 -13px; text-align:center; font-weight: 800;">Υπόμνημα</h4><hr style=" width: 90%;"> -->
              ...
              <div class="row" style="margin: 4px 0;"><div class="col-xs-3 text-right" style="padding: 0px 12px;"><img style="height:30px;" src="img/info/drop401.png"/></div><div class="col-xs-9" style="line-height:115%;">Όλες οι τιμές καυσίμου του πρατηρίου</div></div>
              <div class="row" style="margin: 4px 0;"><div class="col-xs-3 text-right" style="padding: 0px 14px;"><img style="height:30px;" src="img/info/streetView40.png"/></div><div class="col-xs-9" style="line-height:115%;">Εικόνα πρατηρίου απο StreetView</div></div>
