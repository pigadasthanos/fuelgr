            ...
            <div class="modal-body" style="padding-top: 30px;">
                ...
                <?php  
                   ...
                   // echo '<option class="" value="0" '.$extra_attribute.' > ΌΛΕΣ ΤΙΣ ΕΤΑΙΡΙΕΣ</option>';
                        $fuelcompsXML=simplexml_load_file("xml/fuelcomps.xml");
                        $i=0;
                        $j=1;     
                       foreach($fuelcompsXML->RECORD as $brand){
                            ...
                            echo '<option value="'.$brand->fuelCompID.'" '.$extra_attribute.' data-content="<img style=\'width:20px; margin-left:20px; margin-right: 5px;\' src=\'img/logo2/'.$j.'.png\'/></span><span style=\'\'>'.$brand->fuelCompName.'</span>" ></option>';
                            $j+=1;
                       }    
                        echo '</select>';
                ?>
