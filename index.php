  ...
  <body>
      ...
      <div id="container">
        <div id="containerMap"> <!-- container -->
            <div id="cookiesAlert" class="alert alert-warning alert-dismissible" role="alert">
                ...
                <strong>Warning!</strong> Τα cookie μάς βοηθούν να σας παρέχουμε τις υπηρεσίες μας. Εφόσον χρησιμοποιείτε τις υπηρεσίες μας, συμφωνείτε με τη χρήση των cookie από εμάς.
            </div>
            ...
            <?php include('myjs/ajaxGetGasStations.php'); ?>
            <?php include('shared/allFuelPrices.php'); ?>
            <?php include('shared/correction_brands.php'); ?><!-- Κουμπί Διορθωσης Βενζινάδικου-->
            <?php include('shared/selectArea.php'); ?><!-- Κουμπί Επιλογή Περιοχής -->
            <?php include('shared/fuel_types.php'); ?><!-- Κουμπί Τύπου καυσίμου -->
            <?php include('shared/brands.php'); ?><!-- Κουμπί Εταιρία -->
            <?php include('shared/oldness.php'); ?> <!-- Κουμπί Παλαιότητα -->
            <?php include('shared/stationList.php'); ?><!-- Κουμπί Λίστα Πρατηρίων --> 
            <?php include('shared/about.php'); ?><!-- Κουμπί Λίστα Πρατηρίων -->   
            <?php include('shared/disclaimer.php'); ?><!-- Κουμπί Αποποίηση Ευθυνών -->     
        </div> <!-- /containerMap -->
